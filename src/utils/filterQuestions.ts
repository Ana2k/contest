...
export const resetCompletedQuestions = (): void => {
...
export const generateContest = (questions: Question[], difficultyCombination: string): Question[] => {
